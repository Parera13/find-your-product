export const words = [
  ...
  },
  {
    title: "Legumes",
    type: "vegetable",
    description: "Cooked legumes on the wooden table",
    filename: "11.jpg",
    height: 600,
    width: 399,
    price: 14.77,
  ...
  {
    title: "Baked stuffed portobello mushrooms",
    type: "bakery",
    description:
      "Homemade baked stuffed portobello mushrooms with spinach and cheese",
    filename: "15.jpg",
    height: 600,
    width: 400,
    price: 20.31,
  ...
  },
  {
    ...
    type: "fruit",
    description:
      "Peaches on branch with leaves and glasses with peach juice and lemonade with ice cubes in aluminum tray over old metal table. dark rustic style. top view.",
    filename: "49.jpg",
    height: 600,
    width: 400,
    price: 25.62,
